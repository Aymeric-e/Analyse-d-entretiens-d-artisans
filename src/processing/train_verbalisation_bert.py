...
class BertFinalTrainer:
    ...
    def __init__(self, model_name: str = "distilbert-base-multilingual-cased", model_dir: Path = Path("models")):
    ...
    def train(self, X_train: pd.Series, y_train: pd.Series, X_test: pd.Series, y_test: pd.Series,
              learning_rate: float, batch_size: int, max_length: int, num_epochs: int) -> dict:
        """Train BERT model"""
